...
export function TopicRow({
  ...
  const contentUrl = `/dashboard/content/${encodeURIComponent(moduleName)}/${encodeURIComponent(topicName)}`;
  ...
  return (
    <div className={styles.row}>
      ...
      <div className={styles.actions}>
        <Link
          href={`/dashboard/practice/${encodeURIComponent(moduleName)}/${encodeURIComponent(topicName)}`}
